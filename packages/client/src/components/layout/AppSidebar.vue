...
const logoPath = oemConfig.brand.logoPath;
...
<template>
  <aside class="sidebar" :class="{ open: appStore.sidebarOpen, collapsed: appStore.sidebarCollapsed }">
    <div class="sidebar-logo" @click="router.push('/hermes/chat')">
      <img :src="logoPath" :alt="oemConfig.brand.name" class="logo-img" />
      <span class="logo-text">{{ oemConfig.brand.name }}</span>
    ...
    <div class="sidebar-footer">
      ...
      <div class="version-info">
        <div class="version-links">
          <a v-if="oemConfig.links.github" class="github-link" :href="oemConfig.links.github" target="_blank" rel="noopener noreferrer" title="GitHub">
          ...
          <a v-if="oemConfig.links.website" class="website-link" :href="oemConfig.links.website" target="_blank" rel="noopener noreferrer" title="Website">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>
          </a>
        </div>
        <span class="version-text">{{ oemConfig.versionText }}</span>
        <ThemeSwitch />
      </div>
      <NButton v-if="oemConfig.contactUs.buttonText" type="primary" size="tiny" block class="update-btn" @click="openContactUs">
        {{ oemConfig.contactUs.buttonText }}
      </NButton>
      <NButton v-else-if="appStore.clientOutdated" type="warning" size="tiny" block class="update-btn" @click="handleReloadClient">
    ...
    <!-- Contact Us modal -->
    <NModal v-model:show="showContactUs" preset="dialog" :title="oemConfig.contactUs.buttonText" style="width: 400px;">
      <div style="text-align: center; padding: 8px 0;">
        <p style="font-size: 15px; margin-bottom: 16px; color: var(--n-text-color);">{{ oemConfig.contactUs.dialogText }}</p>
        <img v-if="oemConfig.contactUs.dialogImage" :src="oemConfig.contactUs.dialogImage" :alt="oemConfig.contactUs.buttonText" style="max-width: 100%; border-radius: 8px;" />
      </div>
    </NModal>
  </aside>
</template>

...
const thinkingVideoSrc = computed(() => {
  return isDark.value ? oemConfig.thinkingVideo.dark : oemConfig.thinkingVideo.light;
});
...
<template>
  <div ref="listRef" class="message-list">
    <div v-if="chatStore.messages.length === 0" class="empty-state">
      <img :src="oemConfig.emptyState.logoPath" :alt="oemConfig.emptyState.logoAlt" class="empty-logo" />

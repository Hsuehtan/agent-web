export default {
  ...
  chat: {
    ...
    viewAgentDescription: '查看 Agent 身份描述',
  },
  ...
  groupChat: {
    ...
    agentCollaboration: 'Agent 协作模式',
    customRules: '房间自定义规则',
    customRulesPlaceholder: '输入自定义规则，将追加到 Agent 的系统提示词末尾（最高 2000 字符）...',
    customRulesDesc: '自定义规则优先级高于默认规则，如有冲突以自定义规则为准。保存后立即对所有 Agent 生效。',
  },

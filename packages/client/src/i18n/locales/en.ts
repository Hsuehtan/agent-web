export default {
  ...
  chat: {
    ...
    viewAgentDescription: 'View Agent identity description',
  },
  ...
  groupChat: {
    ...
    customRules: 'Room Custom Rules',
    customRulesPlaceholder: 'Enter custom rules, appended to Agent system prompt (max 2000 chars)...',
    customRulesDesc: 'Custom rules take priority over defaults. Saved rules take effect immediately for all Agents.',
  },

  ...
  <div class="login-view">
    <div class="login-card">
      <div class="login-logo">
        <img :src="oemConfig.brand.logoPath" :alt="oemConfig.brand.name" width="80" height="80" />
      </div>
      <h1 class="login-title">{{ oemConfig.brand.loginTitle || t("login.title") }}</h1>
      <p class="login-desc">{{ t("login.description") }}</p>
      <p v-if="oemConfig.loginHintText" class="login-default-hint">{{ oemConfig.loginHintText }}</p>
